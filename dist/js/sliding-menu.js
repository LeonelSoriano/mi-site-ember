$(document).ready(function () {
    ...
    $("#skin-select #toggle").click(function () {
        if ($(this).hasClass('active')) {
            ...
            $('.ul.topnav h4, .hide-min-toggle').css({
                "display": "none"
            });
            ...
            $('img.admin-pic.img-circle').css({
                "margin": "20px 0 0 20px"
            });
            $('.profile span, .profile i, .bottom-list-menu li, .chat-list-menu li').css({
                "display": "block"
            });
            $(".profile h3").css({
                'display': 'block'
